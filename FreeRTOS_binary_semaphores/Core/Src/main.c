...
osThreadId NormalPHandle;
osThreadId BelowPHandle;
...
/* USER CODE BEGIN Header_NormalPriority */
/**
* @brief Function implementing the NormalP thread.
* @param argument: Not used
* @retval None
*/
...
/**
* @brief Function implementing the BelowP thread.
* @param argument: Not used
* @retval None
*/
